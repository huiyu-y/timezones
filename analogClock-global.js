...
function AnalogClock(id, option) {
  ...
  that.option = option;
	...
	that.panel.style.border = "dotted 1px #ccc";
	...
	if (that.width >= 500)//hide if the width is not enough to show the digital clock
	...
	hour.style.borderTop = "solid " + (that.width * 0.5 - hourTop) + "px #000aff";
	...
	min.style.borderTop = "solid " + (that.width * 0.5 - minTop) + "px #000000";
	...
	sec.style.borderTop = "solid " + (that.width * 0.5 - secTop) + "px #000000";
